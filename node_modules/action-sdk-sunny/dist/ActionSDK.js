...
(function (ApiType) {
    ...
    ApiType["AddOrUpdateActionDataRows"] = "AddOrUpdateActionDataRows";
    ...
    // Attachment APIs
    ApiType["UploadAttachment"] = "UploadAttachment";
    ApiType["GetAttachmentInfo"] = "GetAttachmentInfo";
    // Misc APIs
    ApiType["GetContext"] = "GetContext";
    ApiType["HideLoadingIndicator"] = "HideLoadingIndicator";
...
var ActionPermission_1 = __webpack_require__(11);
exports.ActionPermission = ActionPermission_1.ActionPermission;
var ActionRole_1 = __webpack_require__(12);
exports.ActionRole = ActionRole_1.ActionRole;
var AttachmentType_1 = __webpack_require__(13);
exports.AttachmentType = AttachmentType_1.AttachmentType;
var AttachmentUploadStatus_1 = __webpack_require__(14);
exports.AttachmentUploadStatus = AttachmentUploadStatus_1.AttachmentUploadStatus;
// Base API
var BaseApi_1 = __webpack_require__(0);
exports.BaseApi = BaseApi_1.BaseApi;
// Action CRUD APIs
var CreateAction_1 = __webpack_require__(15);
exports.CreateAction = CreateAction_1.CreateAction;
var UpdateAction_1 = __webpack_require__(16);
exports.UpdateAction = UpdateAction_1.UpdateAction;
var DeleteAction_1 = __webpack_require__(17);
exports.DeleteAction = DeleteAction_1.DeleteAction;
var GetAction_1 = __webpack_require__(18);
exports.GetAction = GetAction_1.GetAction;
// Data Row CRUD APIs
var AddActionDataRow_1 = __webpack_require__(19);
exports.AddActionDataRow = AddActionDataRow_1.AddActionDataRow;
var UpdateActionDataRow_1 = __webpack_require__(20);
exports.UpdateActionDataRow = UpdateActionDataRow_1.UpdateActionDataRow;
var AddOrUpdateActionDataRows_1 = __webpack_require__(21);
exports.AddOrUpdateActionDataRows = AddOrUpdateActionDataRows_1.AddOrUpdateActionDataRows;
var DeleteActionDataRow_1 = __webpack_require__(22);
exports.DeleteActionDataRow = DeleteActionDataRow_1.DeleteActionDataRow;
var GetActionDataRow_1 = __webpack_require__(23);
exports.GetActionDataRow = GetActionDataRow_1.GetActionDataRow;
var GetActionDataRows_1 = __webpack_require__(24);
exports.GetActionDataRows = GetActionDataRows_1.GetActionDataRows;
var GetActionDataRowsSummary_1 = __webpack_require__(25);
exports.GetActionDataRowsSummary = GetActionDataRowsSummary_1.GetActionDataRowsSummary;
var DownloadActionDataRowsResult_1 = __webpack_require__(26);
exports.DownloadActionDataRowsResult = DownloadActionDataRowsResult_1.DownloadActionDataRowsResult;
// Action Package APIs
var GetLocalizedStrings_1 = __webpack_require__(27);
exports.GetLocalizedStrings = GetLocalizedStrings_1.GetLocalizedStrings;
// Subscription APIs
var GetSubscriptionMembers_1 = __webpack_require__(28);
exports.GetSubscriptionMembers = GetSubscriptionMembers_1.GetSubscriptionMembers;
var GetSubscriptionMemberCount_1 = __webpack_require__(29);
exports.GetSubscriptionMemberCount = GetSubscriptionMemberCount_1.GetSubscriptionMemberCount;
var GetActionSubscriptionNonParticipants_1 = __webpack_require__(30);
exports.GetActionSubscriptionNonParticipants = GetActionSubscriptionNonParticipants_1.GetActionSubscriptionNonParticipants;
// Misc APIs
var GetContext_1 = __webpack_require__(31);
exports.GetContext = GetContext_1.GetContext;
var HideLoadingIndicator_1 = __webpack_require__(32);
exports.HideLoadingIndicator = HideLoadingIndicator_1.HideLoadingIndicator;
var CloseView_1 = __webpack_require__(33);
...
// Attachment APIs
var UploadAttachment_1 = __webpack_require__(36);
exports.UploadAttachment = UploadAttachment_1.UploadAttachment;
var GetAttachmentInfo_1 = __webpack_require__(37);
exports.GetAttachmentInfo = GetAttachmentInfo_1.GetAttachmentInfo;
...
(function (ActionDataColumnValueType) {
     ...
     */
    ActionDataColumnValueType["AttachmentList"] = "AttachmentList";
...
(function (ActionPermission) {
     ...
     */
    ActionPermission["DataRowsUpdate"] = "dataRows.Update";
})(ActionPermission = exports.ActionPermission || (exports.ActionPermission = {}));
...
(function (ActionRole) {
     ...
     */
    ActionRole["Member"] = "Member";
    /**
     * Role representing the creator of a data-row.
     */
    ActionRole["RowCreator"] = "RowCreator";
...
(function (AttachmentUploadStatus) {
     ...
     */
    AttachmentUploadStatus["Inprogress"] = "InProgress";
    /**
     ...
     */
    AttachmentUploadStatus["Completed"] = "Completed";
})(AttachmentUploadStatus = exports.AttachmentUploadStatus || (exports.AttachmentUploadStatus = {}));
...
(function (UpdateActionDataRow) {
    ...
    var Request = /** @class */ (function (_super) {
         ...
         */
        Request.prototype.validate = function () {
            if (Utils_1.Utils.isEmptyObject(this.dataRow) || Utils_1.Utils.isEmptyString(this.dataRow.id) || Utils_1.Utils.isEmptyString(this.dataRow.actionId) || Utils_1.Utils.isEmptyObject(this.dataRow.columnValues)) {
 ...
 * @category Data Row CRUD API
 */
var AddOrUpdateActionDataRows;
(function (AddOrUpdateActionDataRows) {
    /**
    ...
    var Request = /** @class */ (function (_super) {
         ...
         * @hidden
         */
        function Request(addRows, updateRows) {
            var _this = _super.call(this, ApiType_1.ApiType.AddOrUpdateActionDataRows) || this;
            _this.addRows = addRows;
            _this.updateRows = updateRows;
            return _this;
        }
        /**
         * Validation.
        ...
        Request.prototype.validate = function () {
            if ((!this.addRows || this.addRows.length == 0) && (!this.updateRows || this.updateRows.length == 0)) {
                throw ApiError_1.getApiError(ApiError_1.ApiErrorCategory.InvalidRequest, null, "AddOrUpdateActionDataRows - Invalid addRows and updateRows!");
            }
            if (this.addRows && this.addRows.length > 0) {
                this.addRows.forEach(function (dataRow, index) {
                    if (Utils_1.Utils.isEmptyObject(dataRow) || Utils_1.Utils.isEmptyString(dataRow.actionId) || Utils_1.Utils.isEmptyObject(dataRow.columnValues)) {
                        throw ApiError_1.getApiError(ApiError_1.ApiErrorCategory.InvalidRequest, null, "AddOrUpdateActionDataRows - Invalid addRow at index:" + index + "!");
                    }
                });
            }
            if (this.updateRows && this.updateRows.length > 0) {
                this.updateRows.forEach(function (dataRow, index) {
                    if (Utils_1.Utils.isEmptyObject(dataRow) || Utils_1.Utils.isEmptyString(dataRow.id) || Utils_1.Utils.isEmptyString(dataRow.actionId) || Utils_1.Utils.isEmptyObject(dataRow.columnValues)) {
                        throw ApiError_1.getApiError(ApiError_1.ApiErrorCategory.InvalidRequest, null, "AddOrUpdateActionDataRows - Invalid updateRow at index:" + index + "!");
                    }
                });
            }
        };
    ...
    AddOrUpdateActionDataRows.Request = Request;
    /**
    ...
    var Response = /** @class */ (function (_super) {
         ...
         * @ignore
         */
        function Response(id, addedDataRowIds, error) {
            var _this = _super.call(this, id, error) || this;
            _this.addedDataRowIds = addedDataRowIds;
            return _this;
        }
        return Response;
    }(BaseApi_1.BaseApi.Response));
    AddOrUpdateActionDataRows.Response = Response;
})(AddOrUpdateActionDataRows = exports.AddOrUpdateActionDataRows || (exports.AddOrUpdateActionDataRows = {}));
...
(function (DownloadActionDataRowsResult) {
    ...
    var Request = /** @class */ (function (_super) {
         ...
         * @hidden
         */
        function Request(actionId, fileName, fileType, dataTableName) {
...
(function (HideLoadingIndicator) {
    ...
    var Request = /** @class */ (function (_super) {
         ...
         */
        function Request() {
            return _super.call(this, ApiType_1.ApiType.HideLoadingIndicator) || this;
        }
        return Request;
    }(BaseApi_1.BaseApi.Request));
    HideLoadingIndicator.Request = Request;
    /**
...
})(HideLoadingIndicator = exports.HideLoadingIndicator || (exports.HideLoadingIndicator = {}));
...
var BaseApi_1 = __webpack_require__(0);
var ApiError_1 = __webpack_require__(2);
var ActionSdkHostBridge_1 = __webpack_require__(35);
/**
...
(function (UploadAttachment) {
    ...
    var Request = /** @class */ (function (_super) {
         ...
         * @hidden
         */
        function Request(attachment, mimeType, properties, progressHandler) {
            var _this = _super.call(this, ApiType_1.ApiType.UploadAttachment) || this;
            _this.attachment = attachment;
            _this.mimeType = mimeType;
            _this.progressHandler = progressHandler;
        ...
        Request.prototype.validate = function () {
            if (!this.attachment) {
                throw ApiError_1.getApiError(ApiError_1.ApiErrorCategory.InvalidRequest, null, "UploadAttachment - Invalid attachment!");
            }
            if (Utils_1.Utils.isEmptyString(this.mimeType)) {
                throw ApiError_1.getApiError(ApiError_1.ApiErrorCategory.InvalidRequest, null, "UploadAttachment - Invalid MIME type!");
            }
        };
        return Request;
    }(BaseApi_1.BaseApi.Request));
    ...
    var Response = /** @class */ (function (_super) {
         ...
         * @ignore
         */
        function Response(id, attachmentId, error) {
            var _this = _super.call(this, id, error) || this;
    ...
    UploadAttachment.Response = Response;
})(UploadAttachment = exports.UploadAttachment || (exports.UploadAttachment = {}));
...
(function (GetAttachmentInfo) {
    ...
    var Request = /** @class */ (function (_super) {
        ...
        function Request(attachmentId) {
            var _this = _super.call(this, ApiType_1.ApiType.GetAttachmentInfo) || this;
            _this.attachmentId = attachmentId;
            return _this;
        }
        /**
         ...
         */
        Request.prototype.validate = function () {
            if (Utils_1.Utils.isEmptyString(this.attachmentId)) {
                throw ApiError_1.getApiError(ApiError_1.ApiErrorCategory.InvalidRequest, null, "GetAttachmentInfo - Invalid attachment id!");
            }
        };
        return Request;
    }(BaseApi_1.BaseApi.Request));
    GetAttachmentInfo.Request = Request;
    /**
    ...
    var Response = /** @class */ (function (_super) {
         ...
         * @ignore
         */
        function Response(id, attachmentInfo, error) {
            var _this = _super.call(this, id, error) || this;
    ...
    GetAttachmentInfo.Response = Response;
})(GetAttachmentInfo = exports.GetAttachmentInfo || (exports.GetAttachmentInfo = {}));
